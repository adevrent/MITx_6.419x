...
train_data = utils.load_data(filepath_prefix + 'reviews_train.tsv')
val_data = utils.load_data(filepath_prefix + 'reviews_val.tsv')
test_data = utils.load_data(filepath_prefix + 'reviews_test.tsv')
...
# classifications = p1.classify(test_bow_features, theta, theta_0)
# test_accuracy = p1.accuracy(classifications, test_labels)
